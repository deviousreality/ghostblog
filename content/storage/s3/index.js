...
var Store = function (_BaseStore) {
  ...
  _createClass(Store, [{
    ...
    value: function _delete(fileName, targetDir) {
      ...
      var directory = targetDir || _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'getTargetDir', this).call(this);
    ...
    value: function save(image, targetDir) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _bluebird2.default.all([_get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'getUniqueFileName', _this4).call(_this4, _this4, image, directory), readFileAsync(image.path)]).then(function (_ref) {
